...
#print("Crear una Set")
#Para crear los sets utilizamos las {}
#print("Crear un set vacio")
#conjunto =  {}

#print("Crear un set vacio con el constructor")
#conjunto2 = set()

#print("Crear un set con items")
conjuntoF = {"cosa1","cosa2","cosa3","cosa4"}

#print("\n Midiendo el largo del conjunto")
#Utilizamos la función len() para medir el largo del conjunto
print(conjuntoF)
print(len(conjuntoF))
